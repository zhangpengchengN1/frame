...
import com.example.pengcheng.frame.utils.view.XViewPager;
 ...
 *                     android:name="com.tlgc.zhhz.utils.tools.cyclepager.CycleViewPager"
 *                     android:layout_width="match_parent"
 *                     android:layout_height="150dp"></fragment>
 *在布局中定义 fragment 写入该类
 * 2、
 */
@SuppressLint("NewApi")
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private XViewPager parentViewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager = (XViewPager) view.findViewById(R.id.viewPager);
    ...
    private void setIndicator(int selectedPosition) {
        for (int i = 0; i < indicators.length; i++) {
            indicators[i]
                    .setBackgroundResource(R.drawable.choice_dot);
        }
        if (indicators.length > selectedPosition)
            indicators[selectedPosition]
                    .setBackgroundResource(R.drawable.nochoice_dot);
    }
     ...
     */
    public void disableParentViewPagerTouchEvent(XViewPager parentViewPager) {
        if (parentViewPager != null)
