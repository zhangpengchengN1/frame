package com.example.pengcheng.frame.qrcode.Zxing;
...
import com.example.pengcheng.frame.qrcode.Zxing.camera.CameraManager;
import com.example.pengcheng.frame.qrcode.Zxing.decoding.CaptureActivityHandler;
import com.example.pengcheng.frame.qrcode.Zxing.decoding.InactivityTimer;
import com.example.pengcheng.frame.qrcode.Zxing.decoding.RGBLuminanceSource;
import com.example.pengcheng.frame.qrcode.Zxing.decoding.Utils;
import com.example.pengcheng.frame.qrcode.Zxing.view.ViewfinderView;
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result == null) {
                                Log.i("123", "   -----------");
                                Looper.prepare();
                                Toast.makeText(CaptureActivity.this, "图片格式有误", Toast.LENGTH_SHORT).show();
                                Looper.loop();
                            } else {
